...
public class CartItemBean {
    ...
    public CartItemBean(String strPartNumber, String strModelDescription,
			double dblUnitCost, int iQuantity, double dblTotalCost) {
		super();
	...
	public String toString() {
		return "CartItemBean [strPartNumber=" + strPartNumber
				+ ", strModelDescription=" + strModelDescription
				+ ", dblUnitCost=" + dblUnitCost + ", iQuantity=" + iQuantity
